function getCustomer() {
    ...
    fetch("http://localhost:8084/banking/api/customer?id=" + number)
            .then(res => {
                if (!res.ok)
...
function getAccounts() {
    ...
    fetch("http://localhost:8084/banking/api/customer/accounts?id=" + number)
            .then(res => {
                if (!res.ok)
                    throw new Error(res.status + " (" + res.statusText + ").");
                return res.text();
...
function getBank() {
    ...
    fetch("http://localhost:8084/banking/api/bank?id=" + number)
            .then(res => {
                if (!res.ok)
                    throw new Error(res.status + " (" + res.statusText + ").");
                return res.text();
            ...
            .then(data => {
                document.getElementById("bank_id").innerText = data;
                document.getElementById("err_bank_id").innerText = ""; //clear previous error 
            })
            .catch(err => {
                document.getElementById("bank_id").innerText = "";
                document.getElementById("err_bank_id").innerText = err;
            });
}

function getBankAccounts() {
    let number = document.getElementById("input_bank_accounts_id").value;
    fetch("http://localhost:8084/banking/api/bank/accounts?id=" + number)
            .then(res => {
                if (!res.ok)
                    throw new Error(res.status + " (" + res.statusText + ").");
                return res.text();
...
function getAccount() {
    ...
    fetch("http://localhost:8084/banking/api/account?id=" + number)
            .then(res => {
                if (!res.ok)
                    throw new Error(res.status + " (" + res.statusText + ").");
                return res.text();
...
function getBalance() {
    ...
    fetch("http://localhost:8084/banking/api/account/balance?id=" + number)
            .then(res => {
                if (!res.ok)
                    throw new Error(res.status + " (" + res.statusText + ").");
                return res.text();
...
function getWithdrawals() {
    ...
    fetch("http://localhost:8084/banking/api/account/withdrawals?id=" + number)
            .then(res => {
                if (!res.ok)
                    throw new Error(res.status + " (" + res.statusText + ").");
                return res.text();
...
function getDeposits() {
    let number = document.getElementById("input_acc_withdrawals").value;
    fetch("http://localhost:8084/banking/api/account/deposits?id=" + number)
            .then(res => {
                if (!res.ok)
                    throw new Error(res.status + " (" + res.statusText + ").");
                return res.text();
...
function transferByAccId() {
    ...
    fetch('http://localhost:8084/banking/api/account/transfer/id?' + urlParams, {
        method: 'POST',
        headers: {
...
function transferByAccNumber() {
    ...
    fetch('http://localhost:8084/banking/api/account/transfer/number?' + urlParams, {
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
...
function deposit() {
    ...
    fetch('http://localhost:8084/banking/api/account/deposit?' + urlParams, {
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
...
function withdraw() {
    ...
    fetch('http://localhost:8084/banking/api/account/withdraw?' + urlParams, {
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
